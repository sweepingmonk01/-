...
} from './features/dashboard/dailyOrchestration';
import { useDailyOrchestration } from './features/dashboard/useDailyOrchestration';
...
export default function App() {
  ...
  const { todayPlan } = useDailyOrchestration({
    targetScore,
